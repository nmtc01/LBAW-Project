...
CREATE TABLE moderator (
    moderator_id     INTEGER         REFERENCES "user" (user_id)
);

-- Table: administrator
DROP TABLE IF EXISTS administrator;
CREATE TABLE administrator (
    administrator_id INTEGER         REFERENCES "moderator" (moderator_id)
);
...
CREATE TABLE report_status (
    ...
    comment          TEXT,
    responsible_user INTEGER         REFERENCES "moderator" (moderator_id)
);
