...
* R107: View Profile's History ```/user/{id}```
* R108: Edit Profile Form ```/user/{id}```
* R109: Edit Profile Action ```/user/{id}```
...
R107: View Profile's History
|                       |             |
|-----------------------|-------------|    
|URL                    |```/user/{id}``` |
|Description            | Shows a user's questions, notifications...|
|Method                 | GET |
|Paramaters             | +id:integer (user's primary key)|
...
* R207: Upvote, downvote, follow or report a question ```/question/{id}/interact]```
* R208: View Answer ```/question/{id}/answer```
* R209: Add Answer ```/api/answer```
* R210: Upvote, downvote or report an answer ```/api/answer/{id}/interact```
* R211: View Comment ```/question/{id}/comment```
* R212: Add Comment ```/api/comment```
* R213: Report a comment ```/api/comment/{id}/interact```
...
R207: Upvote, downvote, follow or report a question

|                       |             |                                                                                   
|-----------------------|-------------|--------------------------------------------------------------------------------   
|URL                    |```/question/{id}```                                                    
|Description            | This web resource lets user interact with a question.
|Method                 | PUT                |                                                                            
|Parameters             | +id: integer       | Question id                                                         
|Returns                | 200 OK             | The question was successfully liked, disliked, followed or reported.                              
...
|Description            | Shows the answers section, on the question page. |
|Method                 | GET |
...
R210: Upvote, downvote or report an answer

|                       |             |                                                                                   
|-----------------------|-------------|--------------------------------------------------------------------------------   
|URL                    |```/question/{id}/answer```                                                    
|Description            | This web resource lets user interact with an answer.
|Method                 | PUT                |                                                                            
|Parameters             | +id: integer       | Answer id                                                        
|Returns                | 200 OK             | The answer was successfully liked, disliked or reported.                              
|                       | 400 Bad request    | Error. Error message is specified via a HTTP header.                       
...
* R501: Access moderation area [/admin]
* R502: Ban user [/admin/user/{user_id}/ban] 
* R503: Promote user [/admin/user/{user_id}/promote]
* R504: Demote user [/admin/user/{user_id}/demote]
...
* R512: Delete comment of an answer [/question/{question_id}/answer/{answer_id}/comment/{comment_id}]
...
R512: Delete comment of an answer
