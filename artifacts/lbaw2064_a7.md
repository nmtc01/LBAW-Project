...
* R502: Ban user action [/admin/{id}/user/{id}/ban] 
* R503: Reinstate users action [/admin/{id}/user/{id}/reinstate]
* R504: Edit question [/admin/{id}/question/edit]
* R505: Edit answer [/admin/{id}/answer/edit]
* R506: Edit comment [/admin/{id}/comment/edit]
* R507: Delete question [/admin/{id}/question/delete]
* R508: Delete answer [/admin/{id}/answer/delete]
* R509: Delete comment [/admin/{id}/comment/delete]
