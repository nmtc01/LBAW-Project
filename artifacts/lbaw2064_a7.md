...
* R501: Access moderation area [/admin/{id}]
* R502: Ban user [/admin/{id}/user/{id}/ban] 
* R503: Promote user [/admin/{id}/user/{id}/promote]
* R504: Demote user [/admin/{id}/user/{id}/demote]
* R505: Edit reported question [/admin/{id}/question/edit]
* R506: Edit reported answer [/admin/{id}/answer/edit]
* R507: Edit reported comment [/admin/{id}/comment/edit]
* R508: Delete reported question [/admin/{id}/question/delete]
* R509: Delete reported answer [/admin/{id}/answer/delete]
* R510: Delete reported comment [/admin/{id}/comment/delete]
...
R505: Edit reported question

R506: Edit reported answer

R507: Edit reported comment

R508: Delete reported question

R509: Delete reported answer

R510: Delete reported comment
