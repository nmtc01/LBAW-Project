    ...
    <li id="answer{{$answer->id}}" class="answer_item" data-id = "{{$answer->id}}">
        ...
        <div class="ans-body">
            ...
            <div class=icons-answers>
                ...
                <a class="icon-answers" data-toggle="collapse" data-target="#collapseReport{{$answer->id}}" aria-expanded="false">
        ...
        <div class="collapse collapsed_report" id="collapseReport{{$answer->id}}">
            ...
            <div class="card card-body">
                ...
                <button type="submit" class="btn btn-primary report_answer" data-toggle="collapse" data-target="#collapseReport{{$answer->id}}">Send</button>
            </div>
        </div>
    </li>
    @endforeach
